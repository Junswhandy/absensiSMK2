             ...
             <!-- Main content -->
              <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                  ...
                  <div class="bg-white p-4 rounded-lg shadow">
                      <h2 class="text-xl font-semibold text-blue-600">Total Hadir</h2>
                      <p class="mt-2 text-3xl text-gray-800">123</p>
                  </div>

                  <!-- Card 2 -->
                  <div class="bg-white p-4 rounded-lg shadow">
                      <h2 class="text-xl font-semibold text-blue-600">Total Izin</h2>
                      <p class="mt-2 text-3xl text-gray-800">5</p>
                  </div>

                  <!-- Card 3 -->
                  <div class="bg-white p-4 rounded-lg shadow">
                      <h2 class="text-xl font-semibold text-blue-600">Total Sakit</h2>
                      <p class="mt-2 text-3xl text-gray-800">9</p>
                  </div>

                  <!-- Card 4 -->
                  <div class="bg-white p-4 rounded-lg shadow">
                      <h2 class="text-xl font-semibold text-blue-600">Tidak Hadir</h2>
                      <p class="mt-2 text-3xl text-gray-800">12</p>
                  </div>
              </div>
