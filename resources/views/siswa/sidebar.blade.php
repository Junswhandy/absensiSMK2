...
<body class="bg-light text-neutral font-sans">
    ...
    <div id="sidebar" class=" w-64 bg-primary text-white fixed md:relative min-h-screen transform md:transform-none -translate-x-full md:translate-x-0 transition-transform duration-300 z-30 md:z-auto">
        ...
        <ul class="mt-4 space-y-2">
            <li>
                <a href="{{url("/siswa")}}" class="flex items-center px-6 py-3 hover:bg-secondary hover:text-white transition-colors duration-200">
                    <span class="material-icons mr-3">dashboard</span>
                    <span class="text-lg">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="{{url("siswa/data-siswa")}}" class="flex items-center px-6 py-3 hover:bg-secondary hover:text-white transition-colors duration-200">
                    <span class="material-icons mr-3">people</span>
                    <span class="text-lg">Data Siswa</span>
                </a>
            </li>
